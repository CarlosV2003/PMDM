...
@NamedQueries({
    ...
    , @NamedQuery(name = "AutorPremio.findByAutor", query = "SELECT a FROM AutorPremio a WHERE a.autor = :elAutor")
    , @NamedQuery(name = "AutorPremio.findByCodPremio", query = "SELECT a FROM AutorPremio a WHERE a.autorPremioPK.codPremio = :codPremio")
    , @NamedQuery(name = "AutorPremio.findByPremio", query = "SELECT a FROM AutorPremio a WHERE a.premio = :elPremio ORDER BY a.autorPremioPK.anio")
